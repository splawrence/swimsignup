...
def get_events_by_place_date(location_number, category_number, begin_date, end_date):
    ...
    resp = requests.get('https://groupexpro.com/schedule/embed/json.php?schedule&instructor_id=true&format=jsonp&a=110&location='+ location_number +'&category=' + category_number +'&start=' + begintime_str + '&end=' + endtime_str + '&callback=&_=')
